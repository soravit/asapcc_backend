                        ...
                        JobModel.getcarlicense_incartable({vin:row2[0].job_car_vin_id}).then(([row23]) => {
                                console.log(row23);
                                    transporter.sendMail({
                                        ...
                                        subject: "ASAP Call Center : Job "+row2[0].job_id+"",                      // หัวข้อ
                                        text: "Hello,",                         // ข้อความ
                                        html: "<b>คำนัดหมายของท่านคือหมายเลข "+row2[0].job_id+" ได้นัดหมายเรียบร้อยแล้ว ทะเบียนรถ "+row23[0].car_license+" <br>มีรายการดังนี้:<ol>"+e+"</ol> <br>หากมีข้อสงสัยให้ติดต่อกลับที่ </b><br>ASAP Call Center",                
                                    // ข้อความ
                                    }, (err, info) => {
                                        if (err) {
                                            console.log(err);
